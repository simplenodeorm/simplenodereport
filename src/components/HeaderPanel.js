        ...
        if (margins) {
            return <div className="designChildContainer">
                ...
                <svg width={width} height={height}>
                    ...
                    <line x1={margins[0]} y1={margins[1]} x2={width - margins[2]} y2={margins[1]} stroke="cyan"
                          strokeWidth="0.75"/>
                    <text x={margins[0] + 10} y={margins[1] + 20} fontSize="16" fill="lightGray">Header</text>
                    <line x1={width - margins[2]} y1={margins[1]} x2={width - margins[2]} y2={height} stroke="cyan"
                          strokeWidth="0.75"/>
                </svg>
            </div>;
        } else {
